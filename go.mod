...
require (
	...
	github.com/go-kratos/kratos/cmd/protoc-gen-go-errors/v2 v2.0.0-20260327083312-4ed1bedbb024 // indirect
	github.com/go-kratos/kratos/cmd/protoc-gen-go-http/v2 v2.0.0-20260327083312-4ed1bedbb024 // indirect
