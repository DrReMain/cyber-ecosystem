...
type Data struct {
	...
	ServiceTemplate1        *Data_GRPC             `protobuf:"bytes,3,opt,name=service_template1,json=serviceTemplate1,proto3" json:"service_template1,omitempty"`
	ServiceTemplate1Connect *Data_Connect          `protobuf:"bytes,4,opt,name=service_template1connect,json=serviceTemplate1connect,proto3" json:"service_template1connect,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *Data) GetServiceTemplate1() *Data_GRPC {
	if x != nil {
		return x.ServiceTemplate1
	}
	return nil
}

func (x *Data) GetServiceTemplate1Connect() *Data_Connect {
	if x != nil {
		return x.ServiceTemplate1Connect
	}
	return nil
}
...
const file_conf_proto_rawDesc = "" +
	...
	"\x14slow_query_threshold\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\x12slowQueryThreshold\"\xa2\a\n" +
	"\x04Data\x125\n" +
	"\bdatabase\x18\x01 \x01(\v2\x19.kratos.api.Data.DatabaseR\bdatabase\x12,\n" +
	"\x05redis\x18\x02 \x01(\v2\x16.kratos.api.Data.RedisR\x05redis\x12B\n" +
	"\x11service_template1\x18\x03 \x01(\v2\x15.kratos.api.Data.GRPCR\x10serviceTemplate1\x12S\n" +
	"\x18service_template1connect\x18\x04 \x01(\v2\x18.kratos.api.Data.ConnectR\x17serviceTemplate1connect\x1a\xc0\x02\n" +
	"\bDatabase\x12\x16\n" +
	...
	"\aMetrics\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04pathBKZIgithub.com/DrReMain/cyber-ecosystem/examples/template2/internal/conf;confb\x06proto3"
...
var file_conf_proto_goTypes = []any{
	...
	(*Data_GRPC)(nil),           // 16: kratos.api.Data.GRPC
	(*Data_Connect)(nil),        // 17: kratos.api.Data.Connect
...
var file_conf_proto_depIdxs = []int32{
	...
	16, // 14: kratos.api.Data.service_template1:type_name -> kratos.api.Data.GRPC
	17, // 15: kratos.api.Data.service_template1connect:type_name -> kratos.api.Data.Connect
	...
	18, // 18: kratos.api.Server.Connect.timeout:type_name -> google.protobuf.Duration
	13, // 19: kratos.api.Log.Loki.labels:type_name -> kratos.api.Log.Loki.LabelsEntry
	18, // 20: kratos.api.Log.Loki.batch_wait:type_name -> google.protobuf.Duration
	18, // 21: kratos.api.Log.Ent.slow_query_threshold:type_name -> google.protobuf.Duration
	18, // 22: kratos.api.Data.Database.conn_max_lifetime:type_name -> google.protobuf.Duration
	...
	18, // 25: kratos.api.Data.GRPC.timeout:type_name -> google.protobuf.Duration
	18, // 26: kratos.api.Data.Connect.timeout:type_name -> google.protobuf.Duration
