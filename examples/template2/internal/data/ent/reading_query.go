...
func (_q *ReadingQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *ReadingQuery) FirstIDX(ctx context.Context) string {
...
func (_q *ReadingQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *ReadingQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *ReadingQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *ReadingQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(reading.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
func (_q *ReadingQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(reading.Table, reading.Columns, sqlgraph.NewFieldSpec(reading.FieldID, field.TypeString))
	_spec.From = _q.sql
