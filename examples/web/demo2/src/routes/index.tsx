...
function App() {
	...
	return (
		<main className="page-wrap px-4 pb-8 pt-14">
			<h1 className="text-2xl font-bold mb-6">Demo2 - ts-rest HTTP</h1>
			...
			<section className="mb-8">
				...
				{blogList && (
					<div className="space-y-3">
						...
						{blogList.list?.map(
							(blog: { id: string; title?: string; content?: string }) => (
								<div
									key={blog.id}
						...
						{readingList.list?.map(
							(blog: {
								...
								>
									...
									<button
										onClick={() => recordReading.mutate(blog.id)}
