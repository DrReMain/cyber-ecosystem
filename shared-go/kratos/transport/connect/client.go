...
// BaseURL returns the normalized endpoint base URL. Pass it as the baseURL
// argument to generated connect-go clients:
//
//	cli := v1connect.NewXxxServiceClient(c.HTTPClient(), c.BaseURL(), c.ClientOptions()...)
func (c *Client) BaseURL() string { return c.endpoint }
