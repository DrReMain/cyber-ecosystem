...
// mergeCtx merges two contexts into one.
...
// CancelFunc is the type of the cancel function returned by Merge.
type CancelFunc = context.CancelFunc

// Merge merges two contexts into one.
func Merge(parent1, parent2 context.Context) (context.Context, CancelFunc) {
	mc := &mergeCtx{
		parent1:  parent1,
		parent2:  parent2,
