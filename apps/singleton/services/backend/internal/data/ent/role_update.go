...
func (_u *RoleUpdate) SetSort(v string) *RoleUpdate {
	_u.mutation.SetSort(v)
	return _u
}

// SetNillableSort sets the "sort" field if the given value is not nil.
func (_u *RoleUpdate) SetNillableSort(v *string) *RoleUpdate {
	if v != nil {
		_u.SetSort(*v)
	}
	return _u
...
func (_u *RoleUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.Sort(); ok {
		_spec.SetField(role.FieldSort, field.TypeString, value)
	}
...
// SetSort sets the "sort" field.
func (_u *RoleUpdateOne) SetSort(v string) *RoleUpdateOne {
	_u.mutation.SetSort(v)
	return _u
}

// SetNillableSort sets the "sort" field if the given value is not nil.
func (_u *RoleUpdateOne) SetNillableSort(v *string) *RoleUpdateOne {
	if v != nil {
		_u.SetSort(*v)
	}
	return _u
