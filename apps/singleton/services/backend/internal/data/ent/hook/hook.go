...
// The DataScopeFunc type is an adapter to allow the use of ordinary
// function as DataScope mutator.
type DataScopeFunc func(context.Context, *ent.DataScopeMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f DataScopeFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.DataScopeMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.DataScopeMutation", m)
}
...
// The UserAttributeFunc type is an adapter to allow the use of ordinary
// function as UserAttribute mutator.
type UserAttributeFunc func(context.Context, *ent.UserAttributeMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f UserAttributeFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UserAttributeMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.UserAttributeMutation", m)
}

// The WorkReportFunc type is an adapter to allow the use of ordinary
// function as WorkReport mutator.
type WorkReportFunc func(context.Context, *ent.WorkReportMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f WorkReportFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.WorkReportMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.WorkReportMutation", m)
}
