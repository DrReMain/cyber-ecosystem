...
type Department struct {
	...
	// parent department id, null = root
	ParentID *string `json:"parent_id,omitempty"`
	// materialized path, e.g. /d1/d3/d7/
...
func (*Department) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case department.FieldID, department.FieldSort, department.FieldName, department.FieldCode, department.FieldParentID, department.FieldPath:
