...
func (_q *UserQuery) loadDepartments(ctx context.Context, query *DepartmentQuery, nodes []*User, init func(*User), assign func(*User, *Department)) error {
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(department.FieldID), joinT.C(user.DepartmentsPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(user.DepartmentsPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(user.DepartmentsPrimaryKey[1]))
