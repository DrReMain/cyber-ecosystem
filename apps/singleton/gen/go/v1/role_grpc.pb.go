...
const (
	RoleService_CreateRole_FullMethodName = "/api.singleton.v1.RoleService/CreateRole"
	RoleService_UpdateRole_FullMethodName = "/api.singleton.v1.RoleService/UpdateRole"
	RoleService_DeleteRole_FullMethodName = "/api.singleton.v1.RoleService/DeleteRole"
	RoleService_GetRole_FullMethodName    = "/api.singleton.v1.RoleService/GetRole"
	RoleService_QueryRole_FullMethodName  = "/api.singleton.v1.RoleService/QueryRole"
)
...
type RoleServiceClient interface {
	...
	// QueryRole
	QueryRole(ctx context.Context, in *QueryRoleRequest, opts ...grpc.CallOption) (*QueryRoleResponse, error)
}
...
func (c *roleServiceClient) QueryRole(ctx context.Context, in *QueryRoleRequest, opts ...grpc.CallOption) (*QueryRoleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedRoleServiceServer) QueryRole(context.Context, *QueryRoleRequest) (*QueryRoleResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method QueryRole not implemented")
}
...
var RoleService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.singleton.v1.RoleService",
	...
	Metadata: "singleton/api/v1/role.proto",
}
