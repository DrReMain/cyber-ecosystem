...
const (
	RoleBindingService_CreateRoleBinding_FullMethodName = "/api.singleton.v1.RoleBindingService/CreateRoleBinding"
	RoleBindingService_DeleteRoleBinding_FullMethodName = "/api.singleton.v1.RoleBindingService/DeleteRoleBinding"
	RoleBindingService_ListRoleBindings_FullMethodName  = "/api.singleton.v1.RoleBindingService/ListRoleBindings"
)
...
func (c *roleBindingServiceClient) DeleteRoleBinding(ctx context.Context, in *DeleteRoleBindingRequest, opts ...grpc.CallOption) (*DeleteRoleBindingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedRoleBindingServiceServer) DeleteRoleBinding(context.Context, *DeleteRoleBindingRequest) (*DeleteRoleBindingResponse, error) {
...
var RoleBindingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.singleton.v1.RoleBindingService",
	...
	Metadata: "singleton/api/v1/role_binding.proto",
}
