...
func (_u *ArticleUpdate) SetSort(v string) *ArticleUpdate {
	_u.mutation.SetSort(v)
	return _u
}

// SetNillableSort sets the "sort" field if the given value is not nil.
func (_u *ArticleUpdate) SetNillableSort(v *string) *ArticleUpdate {
	if v != nil {
		_u.SetSort(*v)
	}
	return _u
...
func (_u *ArticleUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.Sort(); ok {
		_spec.SetField(article.FieldSort, field.TypeString, value)
	}
...
// SetSort sets the "sort" field.
func (_u *ArticleUpdateOne) SetSort(v string) *ArticleUpdateOne {
	_u.mutation.SetSort(v)
	return _u
}

// SetNillableSort sets the "sort" field if the given value is not nil.
func (_u *ArticleUpdateOne) SetNillableSort(v *string) *ArticleUpdateOne {
	if v != nil {
		_u.SetSort(*v)
	}
	return _u
