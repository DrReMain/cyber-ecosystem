...
import (
	...
	"cyber-ecosystem/apps/app_1/services/service_1/internal/data/ent/migrate"
	_ "cyber-ecosystem/apps/app_1/services/service_1/internal/data/ent/runtime"
)
...
var defaultErrorReasons = &entutil.DefaultErrorReasons{
	NotFound:    app1V1.ErrorReason_ERROR_REASON_ENT_NOT_FOUND.String(),
	Validation:  app1V1.ErrorReason_ERROR_REASON_ENT_VALIDATION.String(),
	NotSingular: app1V1.ErrorReason_ERROR_REASON_ENT_NOT_SINGULAR.String(),
	NotLoaded:   app1V1.ErrorReason_ERROR_REASON_ENT_NOT_LOADED.String(),
	Constraint:  app1V1.ErrorReason_ERROR_REASON_ENT_CONSTRAINT.String(),
}

var defaultErrorMessages = &entutil.DefaultErrorMessages{
	NotFound:    "",
	Validation:  "",
	NotSingular: "",
	NotLoaded:   "",
...
func HandleError(err error) error {
	return entutil.HandleEntError(err, &entErrorChecker{}, defaultErrorReasons, defaultErrorMessages)
}
