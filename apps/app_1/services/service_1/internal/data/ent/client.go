...
// QueryBlogs queries the blogs edge of a Author.
func (c *AuthorClient) QueryBlogs(_m *Author) *BlogQuery {
...
// QueryAuthors queries the authors edge of a Blog.
func (c *BlogClient) QueryAuthors(_m *Blog) *AuthorQuery {
...
type (
	hooks struct {
		Author, Blog []ent.Hook
	}
	inters struct {
		Author, Blog []ent.Interceptor
	}
)
