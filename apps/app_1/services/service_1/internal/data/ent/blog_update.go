...
func (_u *BlogUpdate) AddAuthorIDs(ids ...string) *BlogUpdate {
	_u.mutation.AddAuthorIDs(ids...)
	return _u
}

// AddAuthors adds the "authors" edges to the Author entity.
func (_u *BlogUpdate) AddAuthors(v ...*Author) *BlogUpdate {
...
func (_u *BlogUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.AuthorsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: false,
			Table:   blog.AuthorsTable,
			Columns: blog.AuthorsPrimaryKey,
			Bidi:    false,
...
// AddAuthorIDs adds the "authors" edge to the Author entity by IDs.
func (_u *BlogUpdateOne) AddAuthorIDs(ids ...string) *BlogUpdateOne {
	_u.mutation.AddAuthorIDs(ids...)
	return _u
}

// AddAuthors adds the "authors" edges to the Author entity.
func (_u *BlogUpdateOne) AddAuthors(v ...*Author) *BlogUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearAuthors clears all "authors" edges to the Author entity.
func (_u *BlogUpdateOne) ClearAuthors() *BlogUpdateOne {
	_u.mutation.ClearAuthors()
	return _u
}

// RemoveAuthorIDs removes the "authors" edge to Author entities by IDs.
func (_u *BlogUpdateOne) RemoveAuthorIDs(ids ...string) *BlogUpdateOne {
	_u.mutation.RemoveAuthorIDs(ids...)
	return _u
}

// RemoveAuthors removes "authors" edges to Author entities.
func (_u *BlogUpdateOne) RemoveAuthors(v ...*Author) *BlogUpdateOne {
	ids := make([]string, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
