...
func (_c *AuthorCreate) SetNillableName(v *string) *AuthorCreate {
	if v != nil {
		_c.SetName(*v)
	}
	return _c
...
func (_c *AuthorCreate) SetID(v string) *AuthorCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *AuthorCreate) SetNillableID(v *string) *AuthorCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *AuthorCreate) AddBlogIDs(ids ...string) *AuthorCreate {
	_c.mutation.AddBlogIDs(ids...)
	return _c
}

// AddBlogs adds the "blogs" edges to the Blog entity.
func (_c *AuthorCreate) AddBlogs(v ...*Blog) *AuthorCreate {
...
func (_c *AuthorCreate) check() error {
	...
	if v, ok := _c.mutation.ID(); ok {
		if err := author.IDValidator(v); err != nil {
			return &ValidationError{Name: "id", err: fmt.Errorf(`ent: validator failed for field "Author.id": %w`, err)}
		}
	}
	return nil
}
