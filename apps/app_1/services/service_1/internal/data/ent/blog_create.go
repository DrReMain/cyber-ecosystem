...
func (_c *BlogCreate) SetNillableTitle(v *string) *BlogCreate {
	if v != nil {
		_c.SetTitle(*v)
	}
	return _c
...
func (_c *BlogCreate) SetNillableContent(v *string) *BlogCreate {
	if v != nil {
		_c.SetContent(*v)
	}
	return _c
...
func (_c *BlogCreate) SetID(v string) *BlogCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *BlogCreate) SetNillableID(v *string) *BlogCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *BlogCreate) AddAuthorIDs(ids ...string) *BlogCreate {
	_c.mutation.AddAuthorIDs(ids...)
	return _c
}

// AddAuthors adds the "authors" edges to the Author entity.
func (_c *BlogCreate) AddAuthors(v ...*Author) *BlogCreate {
...
func (_c *BlogCreate) defaults() error {
	...
	if _, ok := _c.mutation.Title(); !ok {
		if blog.DefaultTitle == nil {
			return fmt.Errorf("ent: uninitialized blog.DefaultTitle (forgotten import ent/runtime?)")
		}
		v := blog.DefaultTitle()
		_c.mutation.SetTitle(v)
	}
	if _, ok := _c.mutation.Content(); !ok {
		if blog.DefaultContent == nil {
			return fmt.Errorf("ent: uninitialized blog.DefaultContent (forgotten import ent/runtime?)")
		}
