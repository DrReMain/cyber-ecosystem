...
func (c *Client) Intercept(interceptors ...Interceptor) {
	c.Reading.Intercept(interceptors...)
}
...
func (c *ReadingClient) UpdateOneID(id string) *ReadingUpdateOne {
...
func (c *ReadingClient) DeleteOneID(id string) *ReadingDeleteOne {
...
func (c *ReadingClient) Get(ctx context.Context, id string) (*Reading, error) {
	return c.Query().Where(reading.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *ReadingClient) GetX(ctx context.Context, id string) *Reading {
