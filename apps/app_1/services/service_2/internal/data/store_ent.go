...
var defaultError = &entutil.DefaultError{
	NotFound:    app1V1.ErrorErrorReasonEntNotFound(""),
	Validation:  app1V1.ErrorErrorReasonEntValidation(""),
	NotSingular: app1V1.ErrorErrorReasonEntNotSingular(""),
	NotLoaded:   app1V1.ErrorErrorReasonEntNotLoaded(""),
	Constraint:  app1V1.ErrorErrorReasonEntConstraint(""),
}
