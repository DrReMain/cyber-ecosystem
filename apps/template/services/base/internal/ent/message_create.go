...
func (_c *MessageCreate) SetSort(v string) *MessageCreate {
...
func (_c *MessageCreate) SetTitle(v string) *MessageCreate {
...
func (_c *MessageCreate) SetStatus(v string) *MessageCreate {
	_c.mutation.SetStatus(v)
	return _c
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (_c *MessageCreate) SetNillableStatus(v *string) *MessageCreate {
	if v != nil {
		_c.SetStatus(*v)
	}
	return _c
...
func (_c *MessageCreate) defaults() error {
...
func (_c *MessageCreate) check() error {
	...
	if _, ok := _c.mutation.Sort(); !ok {
		return &ValidationError{Name: "sort", err: errors.New(`ent: missing required field "Message.sort"`)}
	}
	if _, ok := _c.mutation.Title(); !ok {
		return &ValidationError{Name: "title", err: errors.New(`ent: missing required field "Message.title"`)}
	}
