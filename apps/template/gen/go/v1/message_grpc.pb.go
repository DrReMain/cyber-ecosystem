...
const (
	MessageService_CreateMessage_FullMethodName       = "/api.template.v1.MessageService/CreateMessage"
	MessageService_UpdateMessage_FullMethodName       = "/api.template.v1.MessageService/UpdateMessage"
	MessageService_DeleteMessage_FullMethodName       = "/api.template.v1.MessageService/DeleteMessage"
	MessageService_GetMessage_FullMethodName          = "/api.template.v1.MessageService/GetMessage"
	MessageService_QueryMessage_FullMethodName        = "/api.template.v1.MessageService/QueryMessage"
	MessageService_UpdateMessageStatus_FullMethodName = "/api.template.v1.MessageService/UpdateMessageStatus"
	MessageService_SortMessage_FullMethodName         = "/api.template.v1.MessageService/SortMessage"
)
...
type MessageServiceClient interface {
	...
	// SortMessage
	SortMessage(ctx context.Context, in *SortMessageRequest, opts ...grpc.CallOption) (*SortMessageResponse, error)
}
...
func (c *messageServiceClient) QueryMessage(ctx context.Context, in *QueryMessageRequest, opts ...grpc.CallOption) (*QueryMessageResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(QueryMessageResponse)
	err := c.cc.Invoke(ctx, MessageService_QueryMessage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *messageServiceClient) SortMessage(ctx context.Context, in *SortMessageRequest, opts ...grpc.CallOption) (*SortMessageResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SortMessageResponse)
	err := c.cc.Invoke(ctx, MessageService_SortMessage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMessageServiceServer) QueryMessage(context.Context, *QueryMessageRequest) (*QueryMessageResponse, error) {
...
func (UnimplementedMessageServiceServer) SortMessage(context.Context, *SortMessageRequest) (*SortMessageResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SortMessage not implemented")
}
...
func _MessageService_QueryMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessageServiceServer).QueryMessage(ctx, req.(*QueryMessageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _MessageService_SortMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SortMessageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MessageServiceServer).SortMessage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MessageService_SortMessage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessageServiceServer).SortMessage(ctx, req.(*SortMessageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MessageService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.template.v1.MessageService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SortMessage",
			Handler:    _MessageService_SortMessage_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "template/api/v1/message.proto",
}
