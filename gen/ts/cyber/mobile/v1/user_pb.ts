 ...
 *
 * @generated from message cyber.mobile.v1.User
 */
export type User = Message<"cyber.mobile.v1.User"> & {
  /**
...
/**
 * Describes the message cyber.mobile.v1.User.
 * Use `create(UserSchema)` to create a new message.
 */
export const UserSchema: GenMessage<User> = /*@__PURE__*/
  messageDesc(file_cyber_mobile_v1_user, 0);

/**
 * CreateUser request.
 *
 * @generated from message cyber.mobile.v1.CreateUserRequest
 */
export type CreateUserRequest = Message<"cyber.mobile.v1.CreateUserRequest"> & {
  /**
   * Nickname.
   *
...
/**
 * Describes the message cyber.mobile.v1.CreateUserRequest.
 * Use `create(CreateUserRequestSchema)` to create a new message.
 */
export const CreateUserRequestSchema: GenMessage<CreateUserRequest> = /*@__PURE__*/
  messageDesc(file_cyber_mobile_v1_user, 1);
...
/**
 * Describes the message cyber.mobile.v1.CreateUserResponse.
 ...
 * GetUser request.
 *
 * @generated from message cyber.mobile.v1.GetUserRequest
 */
export type GetUserRequest = Message<"cyber.mobile.v1.GetUserRequest"> & {
  /**
   * User ID.
   *
...
/**
 * Describes the message cyber.mobile.v1.GetUserRequest.
 ...
 * GetUser response.
 *
 * @generated from message cyber.mobile.v1.GetUserResponse
 */
export type GetUserResponse = Message<"cyber.mobile.v1.GetUserResponse"> & {
  /**
   * User detail.
   *
   * @generated from field: cyber.mobile.v1.User user = 1;
   */
  user?: User | undefined;
};

/**
 * Describes the message cyber.mobile.v1.GetUserResponse.
 ...
 * ListUsers request.
 *
 * @generated from message cyber.mobile.v1.ListUsersRequest
 */
export type ListUsersRequest = Message<"cyber.mobile.v1.ListUsersRequest"> & {
  /**
   * Pagination.
   *
...
/**
 * Describes the message cyber.mobile.v1.ListUsersRequest.
 ...
 * ListUsers response.
 *
 * @generated from message cyber.mobile.v1.ListUsersResponse
 */
export type ListUsersResponse = Message<"cyber.mobile.v1.ListUsersResponse"> & {
  /**
   * Pagination info.
   *
   ...
   * User list.
   *
   * @generated from field: repeated cyber.mobile.v1.GetUserResponse list = 2;
   */
  list: GetUserResponse[];
};

/**
 * Describes the message cyber.mobile.v1.ListUsersResponse.
 ...
 *
 * @generated from message cyber.mobile.v1.UpdateUserStatusRequest
 */
export type UpdateUserStatusRequest = Message<"cyber.mobile.v1.UpdateUserStatusRequest"> & {
  /**
   * User ID.
   *
   * @generated from field: optional string id = 1;
...
/**
 * Describes the message cyber.mobile.v1.UpdateUserStatusRequest.
 ...
 *
 * @generated from message cyber.mobile.v1.UpdateUserStatusResponse
 */
export type UpdateUserStatusResponse = Message<"cyber.mobile.v1.UpdateUserStatusResponse"> & {
};

/**
 * Describes the message cyber.mobile.v1.UpdateUserStatusResponse.
 ...
 *
 * @generated from message cyber.mobile.v1.SortUserRequest
 */
export type SortUserRequest = Message<"cyber.mobile.v1.SortUserRequest"> & {
  /**
   * User ID.
   *
   * @generated from field: optional string id = 1;
...
/**
 * Describes the message cyber.mobile.v1.SortUserRequest.
...
export const SortUserRequestSchema: GenMessage<SortUserRequest> = /*@__PURE__*/
  messageDesc(file_cyber_mobile_v1_user, 13);

/**
 * SortUser response.
 *
 * @generated from message cyber.mobile.v1.SortUserResponse
 */
export type SortUserResponse = Message<"cyber.mobile.v1.SortUserResponse"> & {
};

/**
 * Describes the message cyber.mobile.v1.SortUserResponse.
...
export const SortUserResponseSchema: GenMessage<SortUserResponse> = /*@__PURE__*/
  messageDesc(file_cyber_mobile_v1_user, 14);
...
export const MobileUserService: GenService<{
  ...
  serviceDesc(file_cyber_mobile_v1_user, 0);
