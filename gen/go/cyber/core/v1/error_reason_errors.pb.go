...
func IsErrorReasonUserAlreadyExists(err error) bool {
	...
	e := errors.FromError(err)
	return e.Reason == ErrorReason_ERROR_REASON_USER_ALREADY_EXISTS.String() && e.Code == 409
}

// The phone is already created.
func ErrorErrorReasonUserAlreadyExists(format string, args ...interface{}) *errors.Error {
	return errors.New(409, ErrorReason_ERROR_REASON_USER_ALREADY_EXISTS.String(), fmt.Sprintf(format, args...))
}
