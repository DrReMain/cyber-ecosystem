...
const OperationResourceServiceListResource = "/cyber.core.v1.ResourceService/ListResource"
...
func RegisterResourceServiceHTTPServer(s *http.Server, srv ResourceServiceHTTPServer) {
	r := s.Route("/")
	r.Handle("GET", "/api/v1/core/resource", _ResourceService_ListResource0_HTTP_Handler(srv))
}
