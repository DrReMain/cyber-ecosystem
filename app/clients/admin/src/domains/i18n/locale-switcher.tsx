...
export function LocaleSwitcher(props: Readonly<IProps>) {
  ...
  function onKeyDown(e: KeyboardEvent) {
    ...
    // Explicit `string` annotation: biome's type inference for React's
    // generic KeyboardEvent.key is incomplete and would flag every case as
    // unreachable. The local variable provides a precise type signal.
