...
func (_q *DeptQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *DeptQuery) FirstIDX(ctx context.Context) string {
...
func (_q *DeptQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (_q *DeptQuery) OnlyIDX(ctx context.Context) string {
...
func (_q *DeptQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (_q *DeptQuery) IDsX(ctx context.Context) []string {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *DeptQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(dept.Table, dept.Columns, sqlgraph.NewFieldSpec(dept.FieldID, field.TypeString))
	_spec.From = _q.sql
