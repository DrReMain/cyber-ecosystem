...
func NewItemRP(logger *slog.Logger, p *platform.Platform) biz.ItemRP {
	return &itemRP{
		RP: RP{
			log:      logger.With("module", "data/item_rp"),
			platform: p,
		},
	}
}
...
func (rp *itemRP) Create(ctx context.Context, a *biz.Item) (*biz.Item, error) {
...
func (rp *itemRP) Update(ctx context.Context, fieldsMask []string, a *biz.Item) (*biz.Item, error) {
...
func (rp *itemRP) UpdateStatus(ctx context.Context, id, status string) (*biz.Item, error) {
...
func (rp *itemRP) List(ctx context.Context, in *biz.ItemListIn) (*biz.ItemListOut, error) {
...
func (rp *itemRP) Get(ctx context.Context, id string) (*biz.Item, error) {
...
func (rp *itemRP) Sort(ctx context.Context, id string, prevID, nextID *string) (*biz.Item, error) {
...
func mapItem(d *ent.Item) *biz.Item {
	return &biz.Item{
		ID:          d.ID,
