...
import (
	...
	"cyber-ecosystem/app/services/edge_mobile/internal/ent/schema/local_mixins"
)
...
func (MobileUser) Fields() []ent.Field {
	return []ent.Field{
...
func (MobileUser) Edges() []ent.Edge {
	return nil
}

func (MobileUser) Mixin() []ent.Mixin {
	return []ent.Mixin{
		mixins.IDStringMixin{},
		mixins.CreatedUpdatedMixin{},
		local_mixins.SoftDeleteMixin{},
		local_mixins.SortMixin{SoftDelete: true, Table: "mobile_user"},
	}
}

func (MobileUser) Indexes() []ent.Index {
	return []ent.Index{
...
func (MobileUser) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.WithComments(true),
		entsql.Annotation{Table: "mobile_user"},
	}
}
